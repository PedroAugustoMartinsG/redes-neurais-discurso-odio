...
No entanto, limitações computacionais representaram um desafio significativo ao longo do trabalho. Restrições de hardware dificultaram a exploração completa de modelos mais robustos, tanto de imagens como de texto e fine-tuning mais aprofundado. Com maior capacidade computacional, seria possível aplicar arquiteturas mais sofisticadas, ajustar melhor os hiperparâmetros e, possivelmente, alcançar resultados ainda mais expressivos.
